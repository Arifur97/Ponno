...
@section('body')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <form name="editProductForm" class="form-horizontal" action="{{ url('/update-product') }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" name="size_width_id[]" multiple="multiple" data-placeholder="Select Product Size Or Weight">
                                                @foreach($sizeWidths as $sizeWidth)
                                                    @foreach($productSizeWidths as $productSizeWidth)
                                                    <option value="{{ $sizeWidth->id }}" <?php if(array_search($sizeWidth->id, (array)$productSizeWidth ) !== false)   {echo 'selected'; } ?>  >{{ $sizeWidth->size_width_name }}</option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="{{ $productById->product_name }}" name="product_name" class="form-control" id="inputEmail3" placeholder="Product Name">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $productById->product_code }}" name="product_code" class="form-control" id="inputEmail3" placeholder="Product Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3"  class="col-sm-3 control-label">Product Sku</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="product_sku" value="{{ $productById->product_sku }}" class="form-control" id="inputEmail3" placeholder="Product Sku">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3"  class="col-sm-3 control-label">Product Price</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="product_price" value="{{ $productById->product_price }}" class="form-control" id="price" placeholder="Product price">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3"  class="col-sm-3 control-label">Discount Amount</label>
                                        <div class="col-sm-9">
                                            <input type="number" value="{{ $productById->discount_product_amount }}" value="0" onkeyup="discount_price();" name="discount_product_amount" class="form-control" id="product_discount_amount" placeholder="Product Discount Amount">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3"  class="col-sm-3 control-label">Discount Price</label>
                                        <div class="col-sm-9">
                                            <input type="number" value="{{ $productById->discount_product_price }}" name="discount_product_price" class="form-control" id="product_discount_price" placeholder="Product Discount Price" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Made In Country</label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{ $productById->product_country  }}" name="product_country" class="form-control" placeholder="Product Made Country" required/>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="product_short_description" rows="3" class="form-control">{{ $productById->product_short_description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Product Long Description</label>
                                <div class="col-sm-10">
                                    <textarea id="editor1" name="product_long_description" rows="10" cols="80">{{ $productById->product_long_description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Top Image</label>
                                <div class="col-sm-10">
                                    <input type="file" name="top_image" accept="image/*">
                                    <span class="text-danger"> Image size should be 300*300 </span><br/>
                                    <img src="{{ asset($productById->top_image) }}" alt="" height="80" width="80"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Owl Carousel Image</label>
                                <div class="col-sm-10">
                                    <input type="file" name="owl_carousel_image" accept="image/*">
                                    <span class="text-danger"> Image size should be 220*200 </span><br/>
                                    <img src="{{ asset($productById->owl_carousel_image) }}" alt="" height="80" width="80"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <span class="text-danger"> Image size should be 300*300 </span><br/>
                                    <img src="{{ asset($productById->product_image) }}" alt="" height="80" width="80"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{ asset($productSubImage->product_sub_image) }}" alt="" height="80" width="80"/>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" name="btn" class="btn btn-info pull-right" onclick="validate();">Update Product Info</button>
                            </div><!-- /.box-footer -->
    ...
    <script>
        ...
        document.forms['editProductForm'].elements['top_left_one'].value = '{{ $productById->top_left_one }}';
        document.forms['editProductForm'].elements['top_left_two'].value = '{{ $productById->top_left_two }}';
        document.forms['editProductForm'].elements['top_right_one'].value = '{{ $productById->top_right_one }}';
        document.forms['editProductForm'].elements['top_right_two'].value = '{{ $productById->top_right_two }}';
        document.forms['editProductForm'].elements['carousel_slider'].value = '{{ $productById->carousel_slider }}';
        document.forms['editProductForm'].elements['top_product_status'].value = '{{ $productById->top_product_status }}';
