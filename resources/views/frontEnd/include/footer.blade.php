                                ...
                                <div class="widget widget_nav_menu">
                                    ...
                                    <div class="menu-footer-1-container">
                                        <ul id="menu-footer-1" class="menu">
                                            <li id="menu-item-4388" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4388" style="height: 25px;"><a href="{{url('/contact-us')}}">Contact Us</a></li>
                                ...
                                <div class="widget widget_nav_menu">
                                    ...
                                    <div class="menu-footer-3-container">
                                        <ul id="menu-footer-3" class="menu">
                                            <li id="menu-item-4581" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4581" style="height: 25px;"><a href="{{url('/about-us')}}">About Us</a></li>
                                            <li id="menu-item-4582" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4582" style="height: 25px;"><a href="{{url('/delivery-method')}}">Delivery Information</a></li>
                                            <li id="menu-item-4583" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4583" style="height: 25px;"><a href="{{url('/privacy-policy')}}">Privacy Policy</a></li>
                                            <li id="menu-item-4584" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4584" style="height: 25px;"><a href="{{url('/payment-method')}}">Payment Method</a></li>
                                            <li id="menu-item-4406" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4406" style="height: 25px;"><a href="{{url('/FAQ')}}">FAQ</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="wpb_wrapper">
                            <div class="wpo-contact-info widget style-1">
                                <div class="widget widget_nav_menu">
                                    ...
                                    <div class="menu-footer-3-container">
                                        <ul id="menu-footer-3" class="menu">
                                            <li id="menu-item-4581" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4581" style="height: 25px;"><a href="#">Partner With Us </a></li>
                                            ...
                                            <li id="menu-item-4582" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4582" style="height: 25px;"><a href="#">Terms & Conditions</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
